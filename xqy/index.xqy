	...
	<search:operator name="sort">
        ...
        <search:state name="title">
            <search:sort-order direction="ascending" type="xs:string">
                <search:element ns="http://marklogic.com/MLU/project" name="title"/>
            </search:sort-order>
            <search:sort-order>
                <search:score/>
            </search:sort-order>
        ...
        <search:state name="artist">
            <search:sort-order direction="ascending" type="xs:string">
                <search:element ns="http://marklogic.com/MLU/project" name="artist"/>
            </search:sort-order>
            <search:sort-order>
                <search:score/>
            </search:sort-order>
...
declare function local:birthday()
{
    ...
    return if($bday castable as xs:date)
           then let $week := (for $i in //ts:week[. gt $bday]
                                ...
                                return $i)[1]
                return <div class="articalnamelarge">{/ts:proejct[.//ts:week = $week]//ts:title/text()} by {/ts:project[.//ts:week = $week]//ts:artist/text()}</div>
...
(for $article in /ts:proejct 		 
		...
		return (<div>
			<div class="articlename">"{$article//ts:Article/ArticleTitle/text()}" by {$article//ts:AuthorName/text()}</div>
